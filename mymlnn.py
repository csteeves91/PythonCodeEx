# -*- coding: utf-8 -*-
"""
Created on Sat Nov 13 20:32:21 2021
...
print(minmax_X)
nn = nl.net.newff(minmax_X, [20, 6, 1])
nn.trainf = nl.train.train_gd
error_progress = nn.train(X1, y1, epochs=40, goal=0.01)
...
train_test_split(input_data, train_size = 0.8, test_size=0.2)
